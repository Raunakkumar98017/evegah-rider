...
class _BatteryManagementScreenState extends ConsumerState<BatteryManagementScreen> {
  int _currentIndex = 0;

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      // The screen now builds fresh based on the current index
  ...
  // Dynamic tab builder ensures screens reset when navigated away from
  Widget _buildCurrentTab() {
    switch (_currentIndex) {
      case 0:
        return BatteryHomeTab(
          isVisible: true,
          onScanNavigate: () {
            setState(() {
              _currentIndex = 2; // Swapped to Index 2
            });
          },
          onLiveNavigate: () {
            setState(() {
              _currentIndex = 1; // Swapped to Index 1
            });
          },
          onAlertsNavigate: () {
            setState(() {
      ...
      case 1:
        return const BatteryLiveTab(isVisible: true);
      case 2:
        return const BatteryScanTab(isVisible: true);
      case 3:
        return const BatteryMonitoringTab(isVisible: true);
      case 4:
  ...
  // Profile screen moved to its own method to keep code clean
